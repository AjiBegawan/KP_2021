      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h4 mb-4 text-white-800">Tambah Jadwal Dokter</h1>
          <?php echo $this->session->flashdata('message');?>
          <form method="post" action="<?php echo base_url('index.php/KelolaJadwal/proses_tambah') ?>">
    ...
    <div class="form-group col-md-4">
      ...
      <select id="waktu" class="form-control" name="waktu" required="required">
