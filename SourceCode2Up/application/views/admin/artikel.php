                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="tabel_artikel">
                                    <?php echo form_open_multipart('uploadGambarArtikel/upload/' . $row->Id); ?>
                                    ...
                                    <?php echo "</form>" ?></td>
                                <td class="tabel_artikel"><?php echo $row->gambar; ?></td>
                                <td class="tabel_artikel"><img src=" <?= ('upload/' . $row->gambar) ?>" alt="<?= $row->gambar ?>" style="width: 150px;height:150px"></td>
                                <td class="tabel_artikel"><a href="<?php echo site_url('/admin/editArtikel/') . $row->Id ?>"><button type="button" class="btn btn-success">Edit</button></a></td>     
                                <td class="tabel_artikel"><a href="<?php echo site_url('/admin/deleteArtikel/') . $row->Id ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>       
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
