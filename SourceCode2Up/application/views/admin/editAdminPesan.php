...
<body>
    ...
    <div class="container" style="margin-top: 100px;">
        <form method="POST" action="<?php echo site_url('Admin/updatePesan'); ?>">
            <a href="<?php echo site_url('Admin/contact'); ?>"><button type="submit"
                    class="btn btn-warning">Kembali</button></a> <br><br>
            <div class="form-group">
                <label>ID</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="id"
                    value="<?php echo $contact->id; ?>" readonly>
            </div>
            <div class="form-group">
                <label>Nama</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    value="<?php echo $contact->nama; ?>" readonly>

            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    value="<?php echo $contact->email; ?>" readonly>

            </div>
            <div class="form-group">
                <label>Subject</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    value="<?php echo $contact->subject; ?>" readonly>
            </div>
            <div class="form-group">
                <label>Message</label>
                <textarea name="" class="form-control" id="" cols="30" rows="10" value=""
                    readonly><?php echo $contact->message; ?></textarea>
            </div>
            <div class="form-group">
                <label>Status</label>
