            ...
            <table class="table table-condensed table-hover table-striped" style="max-width: 100%; ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tabel_member"><a
                                href="<?php echo site_url('/admin/editUser/') . $row->username ?>"><button type="button"
                                    class="btn btn-success"><i class="icofont-eye-alt"></i></button></a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
