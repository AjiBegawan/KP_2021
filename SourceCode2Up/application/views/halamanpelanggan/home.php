                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 d-flex justify-content-center">
                        <div class="member">
                            ...
                            <div class="social">
                                <a href="https://twitter.com/rubahitam" target="blank"><i
                                        class="icofont-twitter"></i></a>
                                <a href="https://www.instagram.com/rubahitam_/" target="blank"><i
                    ...
                    <div class="col-lg-4 col-md-4 d-flex justify-content-center">
                        <div class="member">
                            ...
                            <div class="social">
                                <a href="https://twitter.com/Suryanto_sur234" target="blank"><i
                                        class="icofont-twitter"></i></a>
                                <a href="https://www.instagram.com/suryanto123/" target="blank"><i
                                        class="icofont-instagram"></i></a>
                                <a href="https://superrare.com/suryanto_nft" target="blank"><i
                    ...
                    <div class="col-lg-4 col-md-4 d-flex justify-content-center">
                        <div class="member">
                            ...
                            <div class="social">
                                ...
                                <a href="https://www.instagram.com/tagapaw/" target="blank"><i
                                        class="icofont-instagram"></i></a>
            ...
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-6 col-md-12" style="margin:16px 0">
                    <a href="<?php echo site_url('Home/BlogView') ?>" class=" ">
                        <img class="card-img-top" src="<?= base_url("assets\img\Home\Web02.jpg") ?>"
                            alt="Card image cap">
                    </a>
                </div>
                <div class="col-lg-6 col-md-12  " style="margin:16px 0">
                    <a href="https://forms.gle/MtH5ZQwyRetxFpYj7" class=" ">
                        <img class="card-img-top" src="<?= base_url("assets\img\Home\Website 01_.jpg") ?>"
                            alt="Card image cap">
                    </a>
                </div>
                <?php } else { ?>
                <div class="col-lg-12 col-md-12" style="margin:16px 0">
                    <a href="https://forms.gle/MtH5ZQwyRetxFpYj7" target=”_blank”>
                        <img class="card-img-top" src="<?= base_url("assets\img\Home\Web03.jpg") ?>"
                            alt="Card image cap">
                    </a>
                </div>
                <?php } ?>
