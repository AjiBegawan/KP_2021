...
<?php 
        ...
        $sql = "SELECT * FROM paket WHERE kategori LIKE 'premium'";
...
<table border="1" align="center">
    <td>
        <div class="row">
            <div class="column" >
            <img src="assets/image/baby12.png" height ="120" width="100" border="4" alt="Contoh 1"  onclick="myFunction(this);">
            </div>
            <div class="column">
                    <img src="assets/image/bayi11.jpeg" height ="120" width="100" border="4" alt="Contoh 2" onclick="myFunction(this);">
            </div>
        </div>
    </td>
