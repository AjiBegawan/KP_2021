...
<?php 
        ...
        $sql = "SELECT * FROM paket WHERE kategori LIKE 'basic'";
...
<table border="0" align="center">
    <td>
        <div class="row">
            <div class="column" >
            <img src="assets/image/baby7.jpeg" height ="120" width="100" border="4" alt="Contoh 1"  onclick="myFunction(this);">
            </div>
            <div class="column">
                    <img src="assets/image/baby8.jpeg" height ="120" width="100" border="4" alt="Contoh 2" onclick="myFunction(this);">
            </div>
        </div>
    </td>
