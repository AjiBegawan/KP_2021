...
<?php 
        ...
        $sql = "SELECT * FROM paket WHERE kategori LIKE 'standar'";
...
<table border="0" align="center">
    <td>
        <div class="row">
            <div class="column" >
            <img src="assets/image/baby10.jpeg" height ="120" width="100" border="4" alt="Contoh 1"  onclick="myFunction(this);">
            </div>
            <div class="column">
                    <img src="assets/image/baby9.jpeg" height ="120" width="100" border="4" alt="Contoh 2" onclick="myFunction(this);">
            </div>
        </div>
    </td>
